...
public class BoardPage {
    public static String pagingStr(int totalCount, int pageSize, int blockPage, int pageNum, String reqUrl, String categoryName) {
        ...
        if (pageTemp != 1) {
            pagingStr.append("<a href='").append(reqUrl).append("?action=view&categoryName=").append(categoryName)
