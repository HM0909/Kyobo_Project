...
<body>
    <form action="${pageContext.request.contextPath}/member/PwFind.do" method="post" name="FindPwFrm">
        <div class="Find_form_wrap">
            <img src="${pageContext.request.contextPath}/images/logo.png" alt="교보문고 로고">
            <input name="user_id" type="text" placeholder="아이디를 입력해 주세요." oninput="checkInput()">
            ...
            <button id="loginButton" class="login_button">이메일로 비밀번호 찾기</button>
        </div>
    </form>
</body>
</html>
