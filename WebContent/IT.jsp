...
<head>
    ...
    .search-bar {
        ...
        display: flex;
        align-items: center;
        margin-left: 10px; /* Adjusted to align with the logo */
        border: 1px solid #ddd;
        border-radius: 25px;
        padding: 5px 15px; /* Adjusted padding */
        height: 40px; /* Adjusted height */
        max-width: 600px; /* Adjusted width */
        position: relative; /* Added to position the search button */
    }
    ...
    .search-bar button {
        ...
        cursor: pointer;
        position: absolute;
        right: 10px; /* Adjusted to align with the input field */
        top: 50%;
        transform: translateY(-50%); /* Center the button vertically */
    }
    .search-bar button img {
        width: 40px; /* Adjust the size of the search icon */
        height: 20px;
    }
    .user-info {
        display: flex;
...
<body>
   ...
   <nav class="nav">
    <ul>
        ...
        <li class="gnb_images">
            <a class="gnb_link active" href="/kyobo/category/Category.do?action=view&categoryName=IT">IT</a>
        </li>
        <li class="gnb_images">
            <a class="gnb_link" href="/kyobo/category/Category.do?action=view&categoryName=Humanities">인문</a>
        </li>
    </ul>
</nav>
